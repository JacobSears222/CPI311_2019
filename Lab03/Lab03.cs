    ...
    public class Lab03 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            projection = Matrix.CreatePerspectiveFieldOfView(
                MathHelper.PiOver2, GraphicsDevice.Viewport.AspectRatio, 0.1f, 1000f);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (isPerspective ^= InputManager.IsKeyPressed(Keys.Tab))
                projection = Matrix.CreatePerspectiveOffCenter(topLeft.X, bottomRight.X, topLeft.Y, bottomRight.Y, nearPlane, farPlane);
            else
                projection = Matrix.CreateOrthographicOffCenter(topLeft.X * 10, bottomRight.X * 10, topLeft.Y, bottomRight.Y * 10, 
                    nearPlane *10, farPlane * 10);

           if (SRT ^= InputManager.IsKeyPressed(Keys.Space))
                        ...
                        world = Matrix.CreateTranslation(torusScale) * Matrix.CreateFromYawPitchRoll(torusRotation.X, torusRotation.Y, torusRotation.Z) * Matrix.CreateScale(torusPosition);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, "CameraPosition" + cameraPosition, new Vector2(20, 20), Color.White);
            spriteBatch.End();
